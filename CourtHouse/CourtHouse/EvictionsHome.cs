...
{
    public partial class EvictionsHome : MetroFramework.Forms.MetroForm
    {
        String connection;
        SqlConnection cn;
        DataTable dt;

        public EvictionsHome()
        {
            InitializeComponent();
        ...
        private void Showallitems()
        {
            try
            {
                ...
                SqlDataAdapter sda = new SqlDataAdapter("GetAllEvictions", cn);
        ...
        private void insertinto_table(string uniqueid)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "InsertNewFileNo";
